 ...
 */
public class BattleLevel3 extends javax.swing.JFrame {
    ...
    public void hideIndicators(){
       ...
       lblPlayerFireImmune.setVisible(false);
       ...
       lblPlayerDowned.setVisible(false);
       lblPlayerImmune.setVisible(false);
     ...
     * Pre: None
     * Post: Sets bars to their max value.
     */
    public void setProgressBars(){
        progressBarPlayerHP.setValue(430);
        progressBarPlayerSP.setValue(150);
        progressBarEnemyHP.setValue(1000);
        progressBarEnemySP.setValue(250);
    }//end setProgressBars
    ...
    /**
     * Shows the victory screen when the player wins
     * Pre: None
     * Post: Hides this screen and shows the victory screen
     */    
    public void victory(){
        if(enemyHP() == 0){
    ...
    /**
     * Shows the defeat screen when the player gets defeated
     * Pre: None
     * Post: Hides this screen and shows the defeat screen
     */
    public void lose(){
        if(playerHP() == 0){
            new GameOverDefeatLevel3().setVisible(true);
            this.setVisible(false);
            clip.stop();
        }
    }//end lose    
    ...
    /**
     * Disables the moves of the player
     * Pre: None
     * Post: Disables all the major decision buttons
     */
    ...
    /**
     * Enables the moves of the player
     * Pre: None
     * Post: Enables all major decision buttons
     */
    ...
    /**
     * Monitors the turn of the battle for player's fire immune
     * Pre: None
     * Post: Counts the turns until it reaches 4. Once it hits 4, the counter resets
     */
    public void playerTurnMonitorSriracha(){
        playerTurnCounterSriracha++;
        if(playerTurnCounterSriracha == 4){
            playerTurnCounterSriracha = 0;
        }
        if(playerTurnCounterSriracha == 3){
            playerSriracha = false;
        }
    }//end playerTurnMonitorSriracha
    
     /**
     * Monitors the turn of the battle for enemy's ice immune
     * Pre: None
     * Post: Counts the turns until it reaches 3. Once it hits 3, the counter resets
     */
    public void enemyTurnMonitorIce(){
        enemyTurnCounterIce++;
        if(enemyTurnCounterIce == 3){
            iceImmune = false;
            enemyTurnCounterIce = 0;
        }
        
    }//end enemyTurnMonitorIce
    ...
    public void playerUsed(int index){
        String[] moveList = {"Attack", "Incinerate", "Blizzard", "Volt", "Power Charge", "Fortify", "Focus", "Guard", "Strawberry Smoothie", "Water", "Sriracha"};
        if(index >= 1 && index <= 3){
    ...
    public void enemyUsed(int index){
        String[] moveList = {"Attack", "Guard", "Scorch", "Power Charge", "Fortify", "Focus", "Ice Wall"};
        if(index == 2){
            progressBarEnemySP.setValue(subtract(enemySP(), 12));
    ...
    public void playerAttack(){
        ...
        //Deciding what happens when the player recieves a critical or not
        if(critChance < critRate && hitChance < playerHitRate && playerOneMoreTurn == false && critHit == false && enemyGuard == false){
            damage = damage*2;
        ...
        }else if(critChance < critRate && hitChance < playerHitRate && playerOneMoreTurn == false && critHit == false && enemyGuard == true){
            damage = damage*2*0.4;
            enemyGuard = false;
            critHit = true;
            ...
            lblEnemyCriticalHit.setVisible(false);
            lblEnemyDmgIndicator.setText("-"+(int)damage); 
        }else if(critChance < critRate && hitChance < playerHitRate && playerOneMoreTurn == true && critHit == true && enemyGuard == false){
            damage = damage*2;
            progressBarEnemyHP.setValue(subtract(enemyHP(), (int)damage));
            lblEnemyHPNum.setText(String.valueOf(enemyHP()));
            lblEnemyCriticalHit.setVisible(true);
            ...
            critHit = false;
            playerOneMoreTurn = false;
        }else if(critChance < critRate && hitChance < playerHitRate && playerOneMoreTurn == true && critHit == true && enemyGuard == true){
            damage = damage*2*0.2;
            progressBarEnemyHP.setValue(subtract(enemyHP(), (int)damage));
            lblEnemyHPNum.setText(String.valueOf(enemyHP()));
            lblEnemyCriticalHit.setVisible(true);
            ...
            critHit = false;
            playerOneMoreTurn = false;
        }else if(hitChance < playerHitRate && enemyGuard == false){
            critHit = false;
            playerOneMoreTurn = false;
            progressBarEnemyHP.setValue(subtract(enemyHP(), (int)damage));
            lblEnemyHPNum.setText(String.valueOf(enemyHP()));
            lblEnemyCriticalHit.setVisible(false);
            lblEnemyDmgIndicator.setText("-"+(int)damage);    
        }else if(hitChance < playerHitRate && enemyGuard == true){
            damage = damage*0.4;
            enemyGuard = false;
            critHit = false;
            playerOneMoreTurn = false;
    ...
    /**
     * Focuses on what happens when player uses the ice attack
     * Pre: None
     * Post: Outputs what happens when the player attacks with ice
     */
    public void playerIceAttack(){
        double damage = 70*2;
        ...
        //Player gaining an additional turn after using the move
        if(playerOneMoreTurn == false && enemyGuard == false && iceImmune == false){
            progressBarEnemyHP.setValue(subtract(enemyHP(), (int)damage));
            lblEnemyHPNum.setText(String.valueOf(enemyHP()));
            ...
            enemyTurn = false;
            playerOneMoreTurn = true;
        }else if(playerOneMoreTurn == false && enemyGuard == true && iceImmune == false){
            progressBarEnemyHP.setValue(subtract(enemyHP(), (int)damage));
            lblEnemyHPNum.setText(String.valueOf(enemyHP()));
            lblEnemyWeak.setVisible(true);
            lblEnemyDmgIndicator.setText("-"+(int)damage);
            enemyGuard = false;
            critHit = true;
        }else if(playerOneMoreTurn == true && iceImmune == false){
            progressBarEnemyHP.setValue(subtract(enemyHP(), (int)damage));
            lblEnemyHPNum.setText(String.valueOf(enemyHP()));
            lblEnemyWeak.setVisible(true);
            lblEnemyDmgIndicator.setText("-"+(int)damage);
            critHit = false;
            playerOneMoreTurn = false;
        }else if(iceImmune == true){
            lblEnemyDmgIndicator.setText("Immune");
        }
    }//end playerIceAttack
    
     /**
     * Focuses on what happens when player uses the electric attack
     * Pre: None
     * Post: Outputs what happens when the player attacks with electric
     */
    public void playerElectricAttack(){
        ...
        lblEnemyHPNum.setText(String.valueOf(enemyHP()));
        lblEnemyDmgIndicator.setText("-"+(int)damage);
    }//end playerElectricAttack
    
    /**
     * Focuses on what happens when the enemy attacks
     * Pre: None
     * Post: It outputs the attack of the enemy
     */
    ...
    /**
     * Focuses on the enemy using a fire attack
     * Pre: None
     * Post: Show what happens when the enemy uses a fire attack
     */
    public void enemyFireAttack(){
        ...
        //Enemy gaining an additional turn after using the move
        if(enemyOneMoreTurn == false && playerGuard == false && playerSriracha == false){
            progressBarPlayerHP.setValue(subtract(playerHP(), (int)damage));
            lblPlayerHPNum.setText(String.valueOf(playerHP()));
            lblPlayerWeak.setVisible(true);
            lblPlayerDmgIndicator.setText("-"+(int)damage);
            lblPlayerDowned.setVisible(true);
            enemyCritHit = true;
            playerTurn = false;
            ...
            delay2.start();
        }else if(enemyOneMoreTurn == false && playerGuard == true && playerSriracha == false){
            progressBarPlayerHP.setValue(subtract(playerHP(), (int)damage));
            lblPlayerHPNum.setText(String.valueOf(playerHP()));
            lblPlayerWeak.setVisible(true);
            lblPlayerDmgIndicator.setText("-"+(int)damage);
            playerGuard = false;
            enemyCritHit = true;
        }else if(enemyOneMoreTurn == true && playerSriracha == false){
            progressBarPlayerHP.setValue(subtract(playerHP(), (int)damage));
            lblPlayerHPNum.setText(String.valueOf(playerHP()));
            lblPlayerWeak.setVisible(true);
            lblPlayerDmgIndicator.setText("-"+(int)damage);
            ...
            delay14.start();   
        }else if(playerSriracha == true){
            lblPlayerImmune.setVisible(true);
            enemyOneMoreTurn = false;
        }   
    }// end enemyFireAttack
    
    /**
     * Focuses on what happens when the enemy uses Ice Wall
     * Pre: None
     * Post: It calculates the chance of when it'll be used, and then shows what happens
     */
    public void enemyIceImmune(){
        //Calculates the rate of when enemy will use ice wall
        if(enemyHP() < 580 && enemyHP() <= 720){
            enemyIceWallRate = 0.55;
        }else if(enemyHP() > 350 && enemyHP() <= 580){
            enemyIceWallRate = 0.95;
        ...
        double enemyIceImmuneChance = rngGenerator();
        
        if(enemyIceImmuneChance < enemyIceWallRate && subtract(enemySP(), 22) >= 0){
           iceImmune = true;
        }
        
        if(enemyTurn == true && iceImmune == true){
            //Keeping track of enemy buffs
            if(enemyTurnCounterIce >= 1){
                enemyTurnMonitorIce();
            }
            ...
            delay8 = new Timer(1000, new ActionListener(){
           
                @Override
                public void actionPerformed(ActionEvent e){
                    lblEnemyIceImmune.setVisible(true);
                    delay8.stop();  
                }
            });
            delay8.start(); 
    ...
    public void enemyHitEvadeUp(){ 
        ...
        //When another buff is active
        if(enemyFortify == true || enemyFocus == true || enemyGuard == true){
            enemyFocusRate = 0.30;
        }
        if(iceImmune == true){
            enemyFocusRate = 1;
     ...
     * Pre: None
     * Post: Show what happens when the enemy guards
     */
    ...
    /**
     * Warn the player's HP when their health is low
     * Pre: None
     * Post: A message will appear at the top right
     */
    public void warnPlayerHPLow(){
        //When player's health is low
        if(playerHP() <= 200){
    ...
    /**
     * Warn the player's SP when their skill points is low
     * Pre: None
     * Post: A message will appear at the top right
     */    
    ...
    public void endEnemyTurn(){
        //Hides downed label if enemy does not get a critical 
        ...
        if(playerTurnCounterSriracha==2){
            lblPlayerFireImmune.setVisible(false);
        }
    ...
    public void CPUEnemy(){
        ...
        if(iceImmune == false && enemyTurn == true){
            enemyIceImmune();
        }
        ...
        if(enemyTurn == true){
            double enemyFireAtkChance = rngGenerator();
            if(enemyFireAtkChance < enemyFireAtkRate && subtract(enemySP(), 22) >= 0){
                //Keeping track of enemy buffs
                if(enemyTurnCounterIce >= 1){
                    enemyTurnMonitorIce();
                }
    ...
    private void initComponents() {
        ...
        btnSriracha.setBackground(new java.awt.Color(255, 204, 102));
        btnSriracha.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        btnSriracha.setText("Sriracha");
        btnSriracha.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSrirachaActionPerformed(evt);
            }
        });
        itemsMenuPanel.add(btnSriracha, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 160, -1));
        ...
        lblSrirachaDesc.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblSrirachaDesc.setText("Become immune to fire attacks for 3 ");
        lblSrirachaDesc.setToolTipText("");
        itemsMenuPanel.add(lblSrirachaDesc, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 200, 490, 40));

        lblSrirachaDesc2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblSrirachaDesc2.setText("turns when consumed.");
        lblSrirachaDesc2.setToolTipText("");
        itemsMenuPanel.add(lblSrirachaDesc2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 240, 490, 40));

        lblAmountOfStrawberrySmoothie.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblAmountOfStrawberrySmoothie.setText("x2");
        ...
        lblAmountOfWater.setText("x2");
        itemsMenuPanel.add(lblAmountOfWater, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 140, -1, -1));

        lblAmountOfSriracha.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblAmountOfSriracha.setText("x1");
        itemsMenuPanel.add(lblAmountOfSriracha, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 200, -1, -1));
        ...
        battleBackPanel.add(itemsMenuPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 940, 310));

        lbFireDemonlEnemy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Fire Demon.png"))); // NOI18N
        battleBackPanel.add(lbFireDemonlEnemy, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 230, 400, 400));
        ...
        progressBarPlayerSP.setMaximum(150);
        ...
        progressBarEnemySP.setMaximum(250);
        ...
        lblEnemyName.setText("Fire Demon");
        ...
        lblPlayerImmune.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblPlayerImmune.setForeground(new java.awt.Color(255, 255, 255));
        lblPlayerImmune.setText("Immune");
        battleBackPanel.add(lblPlayerImmune, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, -1, -1));
        ...
        lblPlayerFireImmune.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblPlayerFireImmune.setForeground(new java.awt.Color(255, 255, 255));
        lblPlayerFireImmune.setText("↑ Fire Immune");
        battleBackPanel.add(lblPlayerFireImmune, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 180, 40));
    ...
    private void btnAttackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAttackActionPerformed
        //Keeps track of the player buffs
        ...
        if(playerTurnCounterSriracha >= 1){
            playerTurnMonitorSriracha();
        }
        ...
        //Delays the enemy's turn until the player's turn is fully complete
        ...
        delay4 = new Timer(6000, new ActionListener(){   
            ...
            public void actionPerformed(ActionEvent e){
                ...
                if(playerTurn == false){
                    ...
                    //Delays ending the enemy's additional turn
        ...
        if(subtract(playerSP(), 12 ) < 0){
            ...
            delay4 = new Timer(6000, new ActionListener(){   
                ...
                public void actionPerformed(ActionEvent e){
                    ...
                    //When player gets an additional turn
                    if(playerTurn == false){
                        disableMoves();
                        //Delays hiding the one more turn message when the enemy's turn loops
                        delay5 = new Timer(1000, new ActionListener(){
    ...
    private void btnGuardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardActionPerformed
        ...
        delay3 = new Timer(4000, new ActionListener(){   
            ...
            public void actionPerformed(ActionEvent e){
                ...
                //When enemy gains an additional turn
                if(playerTurn == false){
                    disableMoves();
    ...
    private void btnSrirachaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSrirachaActionPerformed
        //When the player hits the button
        if(playerSriracha == true && playerTurnCounterSriracha==1){
            itemsMenuPanel.setVisible(false);
            itemsMsgPanel.setVisible(true);
            lblPlayerItemMsg.setText("Sriracha is already active.");     
        }else if(playerSriracha == false || playerTurnCounterSriracha==2){
            playerTurnCounterSriracha = 0;
            if(playerTurnCounterFortify >= 1){
                playerTurnMonitorFortify();
            }
            ...
            //When player has no more of this item
            if(amountOfSriracha == 1){
                btnSriracha.setEnabled(false);
            }
            ...
            delay1 = new Timer(1000, new ActionListener(){
                ...
                public void actionPerformed(ActionEvent e){
                    amountOfSriracha--;
                    lblAmountOfSriracha.setText("x"+amountOfSriracha);
                    lblPlayerFireImmune.setVisible(true);
                    delay1.stop();
                }
            });
            delay1.start();
    ...
    }//GEN-LAST:event_btnSrirachaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BattleLevel3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    double enemyFireAtkRate = 0.85;
    double enemyGuardRate;
    double enemyPowerChargeRate;
    double enemyFortifyRate;
    double enemyFocusRate;
    double enemyIceWallRate;
    boolean playerOneMoreTurn = false;
    boolean enemyOneMoreTurn = false;
    int amountOfStrawberry = 2;
    int amountOfWater = 2;
    int amountOfSriracha = 1;
    ...
    int playerTurnCounterSriracha = 0;
    ...
    private javax.swing.JButton btnSriracha;
    ...
    private javax.swing.JLabel lbFireDemonlEnemy;
    private javax.swing.JLabel lblAmountOfSriracha;
    ...
    private javax.swing.JLabel lblPlayerFireImmune;
    ...
    private javax.swing.JLabel lblPlayerImmune;
    ...
    private javax.swing.JLabel lblSrirachaDesc;
    private javax.swing.JLabel lblSrirachaDesc2;
