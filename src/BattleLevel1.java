 ...
 */
public class BattleLevel1 extends javax.swing.JFrame {
    ...
    public void setProgressBars(){
        ...
        progressBarEnemySP.setValue(150);
    }//end setProgressBars
    ...
    public void lose(){
        if(playerHP()==0){
            new GameOverDefeatLevel1().setVisible(true);
            this.setVisible(false);
            clip.stop();
        }         
    }//end lose
    ...
    public void enemyUsed(int index){
        String[] moveList = {"Attack", "Guard", "Power Charge"};
        if(index == 2){
    ...
    public void playerAttack(){
        ...
        if(playerFocus == true){
            playerHitRate = playerHitRate + 0.35;
        }else{
            playerHitRate = 0.6;
        }
    ...
    /**
     * Focuses on what happens when player uses the fire attack
     * Pre: None
     * Post: Outputs what happens when the player attacks with fire
     */
    public void playerFireAttack(){
        ...
        if(playerOneMoreTurn == false && enemyGuard == false){
            progressBarEnemyHP.setValue(subtract(enemyHP(), (int)damage));
            lblEnemyHPNum.setText(String.valueOf(enemyHP()));
            ...
            enemyTurn = false;
            playerOneMoreTurn = true;
        }else if(playerOneMoreTurn == false && enemyGuard == true){
            progressBarEnemyHP.setValue(subtract(enemyHP(), (int)damage));
            lblEnemyHPNum.setText(String.valueOf(enemyHP()));
            lblEnemyWeak.setVisible(true);
            lblEnemyDmgIndicator.setText("-"+(int)damage);
            enemyGuard = false;
            critHit = true;
        }else if(playerOneMoreTurn == true){
            progressBarEnemyHP.setValue(subtract(enemyHP(), (int)damage));
            lblEnemyHPNum.setText(String.valueOf(enemyHP()));
            lblEnemyWeak.setVisible(true);
            lblEnemyDmgIndicator.setText("-"+(int)damage);
    ...
    /**
     * Focuses on what happens when the player uses the ice attack or electric attack
     * Pre: None
     * Post: Outputs what happens when the player uses these spells
     */
    public void playerIceElectricAttack(){
        double damage = 70;
    ...
    public void enemyAttack(){
        ...
        if(playerFortify == true && playerGuard == false && critChance < critRate && hitChance < enemyHitRate && enemyOneMoreTurn == false){ 
           ...
           //Delays showing that the enemy has an additional turn
    ...
    /**
     * Focuses on what happens when the enemy uses power charge
     * Pre: None
     * Post: Calculate the chances and then outputs what happens
     */
    public void enemyAtkUp(){
        ...
        if(enemyHP()> 720 && enemyHP()<= 1000){
            ...
            enemyPowerChargeRate = 0.75;
        }else if(enemyHP() > 0 && enemyHP() <= 250){
            enemyPowerChargeRate = 0.15;
        }
    ...
    public void enemyGuard(){      
        ...
        if(enemyHP() >= 500 && enemyHP()<= 1000){
            enemyGuardRate = 0.15;
        }else if(enemyHP() > 300 && enemyHP() < 500){
            enemyGuardRate = 0.50;
        }else if(enemyHP() > 0 && enemyHP() <= 300){
            enemyGuardRate = 0.85;
        }
    ...
    private void initComponents() {
        ...
        lbKnightEnemy = new javax.swing.JLabel();
        ...
        lblAmountOfStrawberrySmoothie.setText("x4");
        ...
        lbKnightEnemy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/KnightEnemyPic.png"))); // NOI18N
        battleBackPanel.add(lbKnightEnemy, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 270, 400, 400));
        ...
        battleBackPanel.add(lblEnemyHPNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 170, 60, 30));
        ...
        lblEnemySPNum.setText("150");
        battleBackPanel.add(lblEnemySPNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 210, 60, 30));
        ...
        battleBackPanel.add(progressBarEnemyHP, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 170, 180, 30));

        progressBarEnemySP.setMaximum(150);
        battleBackPanel.add(progressBarEnemySP, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 210, 180, 30));
        ...
        lblEnemyName.setText("Knight");
        battleBackPanel.add(lblEnemyName, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 130, 120, 30));
        ...
        battleBackPanel.add(lblEnemyHP, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 170, 30, 30));
        ...
        battleBackPanel.add(lblEnemySP, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 210, 30, 30));
        ...
        battleBackPanel.add(lblEnemyCriticalHit, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, 130, 40));
        ...
        battleBackPanel.add(lblEnemyDowned, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 390, 110, 40));
        ...
        battleBackPanel.add(lblEnemyWeak, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 470, 100, 40));
        ...
        lblPlayerCriticalHit.setText("Critical Hit");
    ...
    private void btnEscapeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEscapeActionPerformed
        //Ending the game
        new GameOverEscapeLevel1().setVisible(true);
        this.setVisible(false);
        clip.stop();
        ...
        if(subtract(playerSP(), 12 ) < 0){
            ...
            delay4 = new Timer(6000, new ActionListener(){   
                ...
                public void actionPerformed(ActionEvent e){
                    ...
                    //When enemy gets additonal turn
                    if(playerTurn == false){
                        disableMoves();
    ...
    private void btnGuardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardActionPerformed
        ...
        delay3 = new Timer(4000, new ActionListener(){   
            ...
            public void actionPerformed(ActionEvent e){
                ...
                //When enemy has an additonal turn
                if(playerTurn == false){
                    disableMoves();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BattleLevel1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel lbKnightEnemy;
